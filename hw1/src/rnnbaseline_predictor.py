...
from modules.rnnbaseline_net import RnnBaselineNet


class RnnBaselinePredictor(BasePredictor):
    """
    ...
    def __init__(self, embedding,
                 ...
                 similarity='inner_product', dim_rnn=128, num_layers=2, **kwargs):
        super(RnnBaselinePredictor, self).__init__(**kwargs)
        self.model = RnnBaselineNet(embedding.size(1),
                                    dim_rnn=dim_rnn,
