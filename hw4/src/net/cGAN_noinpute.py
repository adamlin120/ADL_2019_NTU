...
class Generator(nn.Module):
    def __init__(self, noise_dim, base_acti_maps, dropout_rate=0.5):
        ...
        self.conv2 = nn.Sequential(
            (nn.ConvTranspose2d(base_acti_maps * 2 ** 5, base_acti_maps * 2 ** 4, 4, 2, 1, bias=False)),
        ...
        self.conv3 = nn.Sequential(
            (nn.ConvTranspose2d(base_acti_maps * 2 ** 4, base_acti_maps * 2 ** 3, 4, 2, 1, bias=False)),
        ...
        self.conv4 = nn.Sequential(
            (nn.ConvTranspose2d(base_acti_maps * 2 ** 3, base_acti_maps * 2 ** 2, 4, 2, 1, bias=False)),
        ...
        self.conv5 = nn.Sequential(
            (nn.ConvTranspose2d(base_acti_maps * 2 ** 2, base_acti_maps * 2 ** 1, 4, 2, 1, bias=False)),
        ...
        self.bn1 = nn.BatchNorm2d(base_acti_maps * 2 ** 5)
        self.bn2 = nn.BatchNorm2d(base_acti_maps * 2 ** 4)
        self.bn3 = nn.BatchNorm2d(base_acti_maps * 2 ** 3)
        self.bn4 = nn.BatchNorm2d(base_acti_maps * 2 ** 2)
